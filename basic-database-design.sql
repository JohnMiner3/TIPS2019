...
CREATE DATABASE [BANKING] ON  
 PRIMARY 
  ( NAME = N'BANKING_PRI_DAT', FILENAME = N'F:\DATA\BANKING.MDF' , SIZE = 32MB, FILEGROWTH = 16MB) 
 LOG ON 
  ( NAME = N'BANKING_ALL_LOG', FILENAME = N'F:\LOG\BANKING.LDF' , SIZE = 32MB, FILEGROWTH = 16MB)
GO
...
ADD FILE
( NAME = N'BANKING_DAT01', FILENAME = N'F:\DATA\BANKING-01.NDF' , SIZE = 32MB, FILEGROWTH = 16MB)
...
ALTER DATABASE [BANKING]
ADD FILE
( NAME = N'BANKING_DAT02', FILENAME = N'F:\DATA\BANKING-02.NDF' , SIZE = 32MB, FILEGROWTH = 16MB)
TO FILEGROUP FG_MULTI_FILE;
GO
...
ALTER DATABASE [BANKING]
ADD FILE
( NAME = N'BANKING_DAT03', FILENAME = N'F:\DATA\BANKING-03.NDF' , SIZE = 32MB, FILEGROWTH = 16MB)
TO FILEGROUP FG_MULTI_FILE;
GO
...
ALTER DATABASE [BANKING]
ADD FILE
( NAME = N'BANKING_DAT04', FILENAME = N'F:\DATA\BANKING-04.NDF' , SIZE = 32MB, FILEGROWTH = 16MB)
TO FILEGROUP FG_MULTI_FILE;
GO
...
/*
   8 - Grant rights at schema level
*/
...
/*
    ~ Table is seen by BANK_ADMIN & BANK_USER ~
*/
...
/*
    ~ Table is seen by BANK_ADMIN ~
*/

-- Delete existing table
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[HISTORY].[CUSTOMER]') AND type in (N'U'))
DROP TABLE [HISTORY].[CUSTOMER]
GO
